...
RSpec.describe TaxRatesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all tax_rates as @tax_rates" do
      ...
      expect(assigns(:tax_rates)).to eq([tax_rate])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested tax_rate as @tax_rate" do
      tax_rate = TaxRate.create! valid_attributes
      get :show, {:id => tax_rate.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested tax_rate as @tax_rate" do
      tax_rate = TaxRate.create! valid_attributes
      get :edit, {:id => tax_rate.to_param}, valid_session
      expect(assigns(:tax_rate)).to eq(tax_rate)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TaxRate" do
        expect {
          post :create, {:tax_rate => valid_attributes}, valid_session
        }.to change(TaxRate, :count).by(1)
      end

      it "assigns a newly created tax_rate as @tax_rate" do
        post :create, {:tax_rate => valid_attributes}, valid_session
        expect(assigns(:tax_rate)).to be_a(TaxRate)
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved tax_rate as @tax_rate" do
        post :create, {:tax_rate => invalid_attributes}, valid_session
        expect(assigns(:tax_rate)).to be_a_new(TaxRate)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested tax_rate" do
        tax_rate = TaxRate.create! valid_attributes
        put :update, {:id => tax_rate.to_param, :tax_rate => new_attributes}, valid_session
        tax_rate.reload
      ...
      it "assigns the requested tax_rate as @tax_rate" do
        tax_rate = TaxRate.create! valid_attributes
        put :update, {:id => tax_rate.to_param, :tax_rate => valid_attributes}, valid_session
        expect(assigns(:tax_rate)).to eq(tax_rate)
      end
    ...
    context "with invalid params" do
      it "assigns the tax_rate as @tax_rate" do
        tax_rate = TaxRate.create! valid_attributes
        put :update, {:id => tax_rate.to_param, :tax_rate => invalid_attributes}, valid_session
        expect(assigns(:tax_rate)).to eq(tax_rate)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested tax_rate" do
      tax_rate = TaxRate.create! valid_attributes
      expect {
        delete :destroy, {:id => tax_rate.to_param}, valid_session
      }.to change(TaxRate, :count).by(-1)
    end
